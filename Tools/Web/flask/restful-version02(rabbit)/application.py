...
from resources import rabbitMQ
...
api = Api(app)
api.add_resource(rabbitMQ.Declare, "/rabbit/declare/<string:name>")
api.add_resource(rabbitMQ.Producer, "/rabbit/producer/<string:name>")
api.add_resource(rabbitMQ.Consumer, "/rabbit/consumer/<string:name>")
